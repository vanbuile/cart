        ...
        <div class="row justify-content-center ">
                          ...
                          <div class="row g-0">
                              ...
                              <div class="col-9 col-lg-8">
                                  <div class="card-body py-0">
                                      ...
                                      <p class="card-text mb-1">'.$order->category.'</p>
                                      <p class="card-text mb-1">Color:  '.$order->color.'</p>
                                      <p class="card-text mb-1">Style:  '.$order->style.'</p>
                                      <p class="card-text mb-1">Quantity:  '.$order->num.'</p>
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <form action="index.php?page=main&controller=cart&action=delete" method="post">
                                                <div class="modal-body">
                                                  ...
                                                  <p>Are you sure remove this order?</p>
                                                </div>
                                                <div class="modal-footer">
                                                  <button class="btn btn-dark btn-outline-light" type="button" data-dismiss="modal">Cancel</button>
                                                  <button class="btn btn-danger btn-outline-light" type="submit">Commit</button>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
          ...
          <div class="col-lg-4 bg-white">
            ...
            <div class="row justify-content-between my-3">
              <div class="col-auto">Estimated Delivery & Handling</div> 
            ...
            <form action="index.php?page=main&controller=checkout&action=index" method="post">
              ...
              <button type=<?php if($sum == 0) echo "button"; else echo "submit"?> onclick=<?php if($sum == 0) echo "emptyCart()"; else echo "none";?> class="d-block w-100 btn btn-dark rounded-pill fw-semibold py-3 mt-3">Checkout</button>
            </form>
          </div>
        </div>
</div>
