                ...
                echo '
                  ...
                  <div class="blog-img position-relative overflow-hidden ">
                    <h2 class="entry-title my-3 mx-3" data-bs-toggle="modal" data-bs-target="#modal-' . $news->id . '">
                      <a href="#" class="link-underline link-underline-opacity-0">' . $news->title . '</a>
                    </h2>
                  </div>
                    ...
                    <div class="entry-content mx-3 mb-5">
                      ...
                      <div class="read-more">
                        ...
                        <button type="button" class="btn btn-info text-white rounded-0 fw-semibold ms-4" data-bs-toggle="modal" data-bs-target="#modal-' . $news->id . '" id=more' . $news->id . '>
                          Read more
                        </button>
                      </div>
                    </div>
              ...
              <?php
                foreach ($recent as $news)
                {
                  ...
                  <div class=" fw-semi-bold align-items-center bg-light px-3 py-3 my-3 bg-info-subtle">
                    <h5><a class="link-underline link-underline-opacity-0" href="blog-single.html" data-bs-toggle="modal" data-bs-target="#modal-' . $news->id . '" id=more' . $news->id . '>' . $news->title . '</a></h5>
